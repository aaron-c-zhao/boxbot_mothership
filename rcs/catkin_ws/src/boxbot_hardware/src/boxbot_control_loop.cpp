...
BoxbotControlLoop::BoxbotControlLoop(ros::NodeHandle& nh,
    ...
    : nh_(nh), hardware_interface_(hardware_interface) {
        ...
        update_period_ = ros::Duration(1 / loop_hz_);
    }

void BoxbotControlLoop::run()
{
...
void BoxbotControlLoop::update()
{
    ...
    const double cycle_time_error = (elapsed_time_ - update_period_).toSec();
